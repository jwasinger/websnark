...
function buildProofAndVK(bn128) {
    ...
    let a_1 = bn128.g1_affine([vk.a[1].x, vk.a[1].y, vk.a[1].z]);
    result.vk.a = bn128.g2_affine( a_0, a_1);

    result.proof.a_p = bn128.g1_affine([proof.a_p[0], proof.a_p[1]]);
...
buildBn128().then( (bn128) => {
	...
	zk.verify = function(vk, input, proof) {
        ...
        let vk_x  = bn128.alloc(192);
        let tmp = bn128.alloc(96);
        ...
        */
        ...
        debugger
        if (!bn128.instance.exports.bn128_pairingEq2(loaded_proof.proof.a, loaded_proof.vk.a, tmp, bn128.instance.exports.pG2gen)) {
